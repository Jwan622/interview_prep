...
data = {'user': [1,1,1,1,1,2,2,2], 'product_id': [456, 87, 788, 456, 87, 456, 788, 456], 'amount': [1,1,3,5,2,1,3,5]}
df = pd.DataFrame(data)
'''
...
'''
sorted_df = grouped_df.groupby('countries').apply(lambda x: x.sort_values(by='amount', ascending=False))
