...
print("index of highest samount: ", df['amounts'].idxmax())
...
print('sorted_df by countries and summed_amount \n', sorted_df)
sorted_df.reset_index(inplace=True)
...
print('just_countries_and_company type \n', type(just_countries_and_company))
