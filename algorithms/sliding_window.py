...
# first example
# if the letters are pq, there are 3 distinct ways of making at most 2 substrings ("p", "q", "pq"). The way this algo does this is pretty interesting though. It doesn't do the permutations of each letter.. but attempts to keep it to linear time.
